...
async function GET(request, props) {
    ...
    try {
        const category = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].category.findUnique({
            where: {
...
async function PUT(request, props) {
    ...
    try {
        ...
        const category = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].category.update({
            where: {
                id: parseInt(params.id)
            },
            data: {
...
async function DELETE(request, props) {
    ...
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].category.delete({
            where: {
                id: parseInt(params.id)
            }
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c03d94._.js.map