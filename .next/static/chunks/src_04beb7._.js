(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_04beb7._.js", {
...
function CandleCard({ id, name, description, price, weight, status, imageUrl, onEdit, onDelete, onManageRecipe }) {
...
function CandlesPage() {
    ...
    const handleEdit = (id)=>{
        alert(`Edit candle ${id}`);
    };
    const handleDelete = (id)=>{
        alert(`Delete candle ${id}`);
    };
    const handleManageRecipe = (id)=>{
        alert(`Manage recipe for candle ${id}`);
    };
    if (isLoading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CandlesPage, "4NyRrYPdq/bfD4vt0czFqHKkf90=", false, function() {
    return [
...
//# sourceMappingURL=src_04beb7._.js.map