...
"[project]/src/app/api/materials/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, props) {
    ...
    try {
        const material = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].material.findUnique({
            where: {
...
async function PUT(request, props) {
    ...
    try {
        ...
        const material = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].material.update({
            where: {
                id: parseInt(params.id)
            },
            data: {
...
async function DELETE(request, props) {
    const params = await props.params;
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].material.delete({
            where: {
                id: parseInt(params.id)
            }
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5aca79._.js.map