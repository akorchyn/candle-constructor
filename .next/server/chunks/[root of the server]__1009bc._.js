...
async function GET() {
    try {
        const materials = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].material.findMany({
            include: {
                category: true
            }
        });
...
async function POST(request) {
    try {
        ...
        const material = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].material.create({
            data: {
                name: json.name,
                units: json.units,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1009bc._.js.map