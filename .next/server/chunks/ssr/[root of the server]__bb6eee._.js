...
function TestPage() {
    ...
    const runTests = async ()=>{
        try {
            ...
            // Test 1: Add recipe
            setResult((prev)=>prev + '\nAdding recipe...');
            const newRecipe = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addRecipe"])({
                candleId: 1,
                materialId: 1,
                amountUsed: 150
            });
            ...
            setResult((prev)=>prev + '\nUpdating recipe...');
            const updatedRecipe = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateRecipe"])(newRecipe.id, {
                amountUsed: 175
            });
            setResult((prev)=>prev + `\nRecipe updated successfully: ${JSON.stringify(updatedRecipe, null, 2)}\n`);
            // Test 3: Delete recipe
            setResult((prev)=>prev + '\nDeleting recipe...');
            const deleteResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteRecipe"])(newRecipe.id);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__bb6eee._.js.map