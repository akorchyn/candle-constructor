...
"[project]/src/app/api/recipes/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
        ...
        const recipe = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].candleRecipe.update({
            where: {
...
async function DELETE(request, { params }) {
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].candleRecipe.delete({
            where: {
                id: parseInt(params.id)
            }
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5697a5._.js.map